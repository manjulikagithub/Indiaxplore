            ...
            <div className="w-full lg:w-5/12 lg:sticky lg:top-32 relative">
                <div className="glass-panel rounded-[32px] p-3 overflow-hidden">
                    <div className="relative rounded-2xl overflow-hidden aspect-[4/5]">
                        <img src="https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Kerala Backwaters" className="w-full h-full object-cover"/>
                        ...
                        <div className="absolute bottom-8 left-8 right-8">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/20 backdrop-blur-md border border-white/30 text-xs font-semibold uppercase tracking-wider mb-3">
                                <MapPin className="w-3 h-3" /> Kerala
                            </div>
                            <h1 className="text-4xl md:text-5xl font-bold text-white mb-2 shadow-sm">Kerala</h1>
                            <p className="text-slate-200 text-sm font-medium opacity-90">God's Own Country</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                    ...
                    <div className="glass-panel p-4 rounded-2xl flex flex-col items-center justify-center text-center">
                        ...
                        <span className="font-bold text-lg">Sep - Mar</span>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full lg:w-7/12 flex flex-col gap-6">
                ...
                <div className="glass-panel rounded-[32px] p-8 md:p-10 border-t border-white/20 shadow-2xl relative overflow-hidden">
                    ...
                    <div id="loading-state" className="hidden flex-col items-center justify-center py-10 mt-4">
                        ...
                        <p className="text-orange-accent font-medium animate-pulse">Crafting your perfect Kerala experience...</p>
                        <p className="text-xs text-slate-500 mt-2">Checking flights, houseboats, and local dining...</p>
                    </div>
                    ...
                    <div className="glass-panel rounded-3xl p-8 border border-green-500/30 relative overflow-hidden">
                        ...
                        <div className="bg-slate-900/60 rounded-2xl p-6 mb-8 border border-slate-700">
                            <div className="space-y-4 text-sm font-medium">
                                ...
                                <div className="flex justify-between items-center pb-4 border-b border-slate-700/50">
                                    <span className="text-slate-400 flex items-center gap-2"><Hotel className="w-4 h-4" /> <span id="hotel-days-label">Accommodations (15 Days)</span></span>
